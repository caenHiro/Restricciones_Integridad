...
APELLIDO_PATERNO_IN VARCHAR(35), APELLIDO_MATERNO_IN VARCHAR(35) ) 
  RETURNS VOID AS $$
    ...
    , $4 || ' '|| $5 || '  '||$6
    USING HINT = 'REVISA QUE TU NOMBRE DEL REPRESENTANTE NO SE ENCUENTRE YA REGISTRADO EN LA TABLA.';
    RETURN  ;
   END IF ;
      END;
    $$ LANGUAGE PLPGSQL;
...
ASOCIACION_IN DECIMAL(1,0),PARTIDO_CANDIDATO_IN DECIMAL(6,0), NOMBRE_IN VARCHAR(35), 
APELLIDO_PATERNO_IN VARCHAR(35), APELLIDO_MATERNO_IN VARCHAR(35) )  
IS ' Procedimiento encargado de registrar a un responsable de acreditación.';