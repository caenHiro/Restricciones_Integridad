...
COMMENT ON FUNCTION VALIDA_CLAVE_ELECTOR(  VARCHAR(20)    ) IS
  'Función encargada de validar que la clave de elector contenga el
   formato solicitado, esto es que  esté conformada  por 4 
   caracteres alfabéticos que son las consonantes iniciales de los 
   apellidos y el nombre del elector, 6 numéricos que contienen su 
   fecha de nacimiento iniciando por el año  y uno del sexo H si es 
   ombre y M si es mujer. '; 